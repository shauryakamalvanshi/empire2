      ...
      <nav className="bg-white 0">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <button
            ...
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm  rounded-lg md:hidden bg-white focus:outline-none focus:ring-2 focus:ring-gray-200 text-gray-400 hover:text-white"
